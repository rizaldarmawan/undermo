...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index2.html" class="logo">
      ...
      <span class="logo-lg"><b>Undermo</b>LTE</span>
    </a>
        ...
        <div class="col-md-12">
          <div class="box">
            <div class="box-header with-border">
              <h3 class="box-title">Galileo 01</h3>
              <!-- tombol minimize -->
            ...
            <div class="box-body">
              <div class="row">
                ...
                <!-- /.col -->
                <div class="col-md-4" id="dataLain">
                  <p class="text-center">
    ...
    // var ycpu;
      $(function () {
        ...
        window.setInterval(function(){
            ...
            interactive_plot.setData([getCpuData()])
